...
An educational implementation of a Decoder-only Transformer in PyTorch, based on Andrej Karpathy's [Let's Build GPT](https://www.youtube.com/watch?v=kCc8FmEb1nY) tutorial, adding a Stateful Key-Value (KV) Cache from scratch.
